...
void VGA_screen_norm_cursor() {
    // if(cursor_x < 0) {
    //     cursor_y--;
    //     cursor_x = 0;
    //     while (VGA_screen_get_char(cursor_x, cursor_y) != 0)
    //         cursor_x++;
    //     cursor_x--;
    // }
...
void VGA_screen_flush() {
    ...
    //     } else if (buffer[i] == 8) {
    //         cursor_x--;
    //         VGA_screen_norm_cursor();
    //         VGA_screen_put_char(0, cursor_x, cursor_y);
    //     } else {
    //         VGA_screen_put_char(buffer[i], cursor_x, cursor_y);
    //         cursor_x++;
    //         VGA_screen_norm_cursor();
    //     }
    // }
